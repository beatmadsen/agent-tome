...
class ExitCodeSuccessTest < Minitest::Test
  ...
  def test_addend_success_exits_zero
    created = create_article!(description: "Article for addend exit check", body: "Initial body.")
  ...
  def test_fetch_success_exits_zero
    created = create_article!(description: "Article for fetch exit check", body: "Body.")
  ...
  def test_consolidate_success_exits_zero
    created = create_article!(description: "Article for consolidate exit check", body: "Body.")
  ...
  def test_related_success_exits_zero
    created = create_article!(description: "Article for related exit check", body: "Body.")
